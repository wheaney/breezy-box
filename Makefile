...
KMS_COMPOSITOR_SOURCES := $(addprefix $(SRC_DIR)/,displaylink_kms_renderer.c display_renderer.c overlay_text.c breezy_state.c usbip.c udl_device.c udl_runtime.c server.c display_placement.c breezy_imu.c breezy_settings.c usb_gadget.c link_services.c) $(COMPAT_SOURCES)
